...
const Sidebar = () => {
  ...
  return (
    <>
      <nav
        className="fixed top-0 z-50 w-full bg-grayishCharcoal border-b border-gray-600">
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center lg:justify-start justify-between">
            <button
              onClick={toggleSidebar} 
              aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2 text-sm rounded-lg lg:hidden hover:bg-lightCharcoal focus:outline-none focus:ring-2 text-gray-300 focus:ring-gray-600">
      ...
      <aside id="logo-sidebar"
        className={`fixed top-0 left-0 z-40 w-48 h-screen transition-transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 pt-20 border-r border-gray-600 bg-grayishCharcoal`}
        aria-label="Sidebar">
          ...
          <ul className="space-y-2">
            <li>
              <a href="/recibos" className="flex items-center p-2 rounded-lg text-gray-200 hover:text-white group">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Recibos</span>
              </a>
            </li>
